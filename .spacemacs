...
before packages are loaded."
  ...
  (setq org-capture-templates
        '(("n" "iNterruption" entry (file+olp+datetree "journal.org")
          ...
          ("qt" "Todo" entry (file "")
           "* TODO %? %^G\n %U\n %i")
          ("qo" "todo On" entry (file "")
           "* TODO %? %^G\n SCHEDULED: %^t\n %U\n %i")
          ("qb" "todo By" entry (file "")
           "* TODO %? %^G\n DEADLINE: %^t\n%U\n %i")
          ...
          ("wt" "incoming Todo" entry (file+olp "work.org" "incoming requests")
           "* TODO %?\n %^G\n %U\n %i")
  ...
  (defun fork-org-push-mobile ()
    (async-start
     ...
     `(lambda ()
        (require 'org-mobile)
        ,(async-inject-variables "org-\\(mobile-\\|directory\\|agenda-files\\)")
        (org-mobile-push))
     ; What to do when it finishes
     (lambda (result)
       (notify-org-push-done result))))

  ;; Define a timer variable
  (defvar org-mobile-push-timer nil
    "Timer that `org-mobile-push-with-delay' is using to throttle auto-pushing, or nil.")
  ...
  ;; After saving files, start an idle timer after which to exec the push
